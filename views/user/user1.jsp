            ...
            <div class="col-md-12 col-xl-5">
                ...
                <div class="card" style="border-radius: 15px;">
                    <div class="card-body text-center">
                        <div class="mt-3 mb-4">
                            <img  id="qrImage" src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava2-bg.webp" alt="QR Code"
...
<script>
    function showQR(url) {
        // Set the src attribute of the qrImage element with the generated QR code URL
    ...
    // Attach a submit event listener to the generateQRForm
    document.getElementById('generateQRForm').addEventListener('submit', function (event) {
        event.preventDefault(); // Prevent the form from submitting normally

        // Make an AJAX request to fetch the QR code URL
        var xhr = new XMLHttpRequest();
        xhr.open('GET', this.action + '?userId=' + this.elements['userId'].value, true);
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4 && xhr.status === 200) {
                var url = '<%= request.getSession().getAttribute("QR_URL")%>';
                showQR(url);
            }
        };
        xhr.send();
